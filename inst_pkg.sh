...
tools="pbzip2 pigz iw p7zip-full arj zip mscompress unar eject bc less vim ftp telnet nmap tftp ntpdate screen lsof strace ltrace parallel lftp"
...
func SetTitle()
    if expand ("%:e") == 'sh'
        ...
        call setline(5, "    exec 5> debug_output.log")
