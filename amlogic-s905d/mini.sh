...
VERSION+=("aa69917[2022-07-12T15:57:38+08:00]:mini.sh")
################################################################################
source ${DIRNAME}/os_debian_init.sh

ROOTFS=${1:?rootfs need input}

chroot ${ROOTFS}/ /bin/bash -s <<EOF
    debian_minimum_init
EOF
macaddr=
...
echo "rsync -avzP --numeric-ids -e 'ssh -p60022' --exclude=boot --delete ${ROOTFS}/* root@${IP:-10.32.166.32}:/overlay/lower/"
