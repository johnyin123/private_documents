...
LD_OPTS=${LD_OPTS:-"-Wl,-Bstatic -lsqlite3 -lcrypt -lbrotlienc -lbrotlidec -lbrotlicommon -Wl,-Bdynamic -Wl,-z,relro -Wl,-z,now -fPIC -L${MYLIB_DEPS}/lib -L${MYLIB_DEPS}/lib/quickjs -lxml2 -liconv -lm"}
...
declare -A DYNAMIC_MODULES=(
    [${DIRNAME}/njs/nginx]="git clone --depth 1 --branch 0.8.2 https://github.com/nginx/njs.git, https://bellard.org/quickjs/"
