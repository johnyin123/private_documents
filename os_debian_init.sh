...
VERSION+=("bf4e0090[2025-05-20T07:09:43+08:00]:os_debian_init.sh")
...
func SetTitle()
    ...
    if expand ("%:e") == 'py'
        ...
        call setline(6, "logging.basicConfig(encoding='utf-8', level=logging.INFO, format='[%(funcName)s@%(filename)s(%(lineno)d)]%(name)s %(levelname)s: %(message)s')")
