...
VERSION+=("cedc04b[2024-11-13T10:20:15+08:00]:os_debian_init.sh")
...
func SetTitle()
    ...
    if expand ("%:e") == 'py'
        ...
        call setline(6, "logging.basicConfig(encoding='utf-8', level=logging.INFO, format='%(asctime)s %(levelname)s: %(message)s')")
