...
# # env: DATA_DIR, TOKEN_DIR, META_SRV, GOLD_SRV, CTRL_SRV, CTRL_KEY
...
URL_CTRL    = f'https://{CTRL_SRV}/guest.html'
...
FILE_DEVS   = os.path.join(DATA_DIR, 'devices.json')
...
def dumps():
    ...
    return {'DATA_DIR': DATA_DIR, 'TOKEN_DIR': TOKEN_DIR, 'ETCD_PREFIX': ETCD_PREFIX, 'ETCD_SRV': ETCD_SRV, 'ETCD_PORT': ETCD_PORT, 'ETCD_CA': ETCD_CA, 'ETCD_KEY': ETCD_KEY, 'ETCD_CERT': ETCD_CERT, 'META_SRV': META_SRV, 'GOLD_SRV': GOLD_SRV, 'CTRL_SRV': CTRL_SRV, 'MAIL':'johnyin.news@163.com','VERSION':'37a2521d', **ACT_PARMS}
