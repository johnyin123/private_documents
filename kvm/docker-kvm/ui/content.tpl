...
<div id="createvm" class="tabContent">
  <div class="form-wrapper">
    ...
    <form id="createvm_form">
      ...
      <label>ip*<input type="text" name="vm_ip" placeholder="ipaddr 192.168.168.2/24" required pattern="^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?).){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)/([1-9]{1}|1[0-9]{1}|2[0-9]{1}|3[0-2]{1})$"/></label>
