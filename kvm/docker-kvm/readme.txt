...
gen_ngx_conf            : gen nginx kvm.conf for vmmgr-api
                          OUTDIR=/home/johnyin/vmmgr CTRL_PANEL_SRV=guest.registry.local GRAPH_SRV=ws.registry.local ./gen_ngx_conf > kvm.conf
...
echo 'display vnc'     && curl -k ${srv}/vm/display/${host}/${uuid} #?timeout_mins=10 #default config.TMOUT_MINS_SOCAT
echo 'console'         && curl -k ${srv}/vm/console/${host}/${uuid} #?timeout_mins=10 #default config.TMOUT_MINS_SOCAT
